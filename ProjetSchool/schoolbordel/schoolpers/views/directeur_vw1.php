    ...
    <div class="container">
        <div class="row"><h3>Ajouter un élève</h3>
            <form action="../ctrl/insert_eleve_ctrl.php" method="post">
                ...
                <div class="form-group">
                    <input type="text" class="form-control"  placeholder="Age de l'élève" name="age" required>
                </div>
                <div class="form-group">
                    <input type="text" class="form-control" placeholder="Ajouter un identifiant" name="identifiant" required>
                </div>
                <div class="form-group">
                    <input type="password" class="form-control" placeholder="Ajouter un mot de passe" name="mdp" required>
                </div>
                <div class="form-group">
                    <input type="text" class="form-control" placeholder="Classe de l'élève" name="classe" required>
                </div>
                <div class="form-group">
                    <input type="text" class="form-control"  placeholder="id de l'élève" name="eleve_id" required>
                </div>
                <div class="form-group">
                    <input type="mail" class="form-control" placeholder="mail des parents" name="emailParent">
                </div>
